...
CREATE TABLE users (
    ...
    INSERT INTO users(user_name, age,plan_id, signature_date)
...
CREATE TABLE musics (
    ...
    FOREIGN KEY (album_id)
      ...
      INSERT INTO musics(music_name, music_time, album_id)
...
CREATE TABLE history (
    ...
    FOREIGN KEY (user_id)
      ...
      INSERT INTO history(music_id, reproduction_date, user_id)
